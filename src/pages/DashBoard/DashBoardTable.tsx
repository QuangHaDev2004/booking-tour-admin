  ...
  return (
    <>
      <table className="text-secondary w-full min-w-[1076px] border-collapse">
        ...
        <tbody>
          <tr>
            <td className="text-primary border-four border-b px-6 py-2.5 text-sm font-bold">
              OD000001
            </td>
            <td className="border-four border-b px-6 py-2.5 text-sm font-semibold">
            ...
            <td className="border-four border-b px-6 py-2.5">
              <Badge className="badge-yellow" content="Khởi tạo" />
            </td>
            <td className="border-four border-b px-6 py-2.5 text-right text-sm font-semibold">
              <div>16:20</div>
              <div>01/01/2024</div>
            </td>
          </tr>
